<template>
    <div id="puzzle">
        ...
        <div class="box">
            ...
            <div v-for='(pic,index) in pics' :key='index' @click='(pic.alive && !pic.select) && doit(pic)' class='cover' :class='{rollback: pic.select}'>
                <div class='back'></div>
                <div class='front'>
...
export default {
            ...
            pics: [
                {
                    k: 1,
                    p:
                        "https://wx3.sinaimg.cn/mw690/69924d1bgy1fpdtejy26ij206o08bwhb.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
                ...
                },
                {
                    k: 2,
                    p:
                        "https://wx1.sinaimg.cn/mw690/69924d1bgy1fpdteje2hvj206i08376c.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
                ...
                },
                {
                    k: 3,
                    p:
                        "https://wx4.sinaimg.cn/mw690/69924d1bgy1fpdteiqsl1j206y08q0w2.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
                ...
                },
                {
                    k: 4,
                    p:
                        "https://wx4.sinaimg.cn/mw690/69924d1bgy1fpdtei0f48j206y08nq4t.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
                ...
                },
                {
                    k: 5,
                    p:
                        "https://wx2.sinaimg.cn/mw690/69924d1bgy1fpdtehg5ynj206o08cta3.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
                ...
                },
                {
                    k: 6,
                    p:
                        "https://wx4.sinaimg.cn/mw690/69924d1bgy1fpdtegwcrvj206j086aal.jpg",
                    select: false,
                    alive: false,
                    done: false
                },
    ...
    methods: {
        ...
        refresh: function() {
            ...
            let y =
                this.highscore.min * 60000 +
                this.highscore.ss * 100 +
                this.highscore.ms;
            if (x < y || y == 0) {
...
.cover:hover {
    -moz-box-shadow: 1px 1px 10px #ff4adb, -4px 3px 9px #f0ff69,
        5px 1px 8px #85ffff;
    -webkit-box-shadow: 1px 1px 10px #ff4adb, -4px 3px 9px #f0ff69,
        5px 1px 8px #85ffff;
